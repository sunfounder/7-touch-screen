...
TS-7C It uses a premium integrated 
...
<a id="license"></a>
## License
This is the code for SunFounder TS-7C 7-touch-screen.
...
7-touch-screen comes with ABSOLUTELY NO WARRANTY; for details run ./show w. This is free software, and you are welcome to redistribute it under certain conditions; run ./show c for details.

SunFounder, Inc., hereby disclaims all copyright interest in the program '7-touch-screen' (which makes passes at compilers).
